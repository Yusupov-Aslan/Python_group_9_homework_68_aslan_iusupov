...
from webapp.views import (
    ...
    ArticleView,
    ArticleUpdateView,
    ArticleDeleteView, IndexView, CommentCreateView, CommentUpdateView, CommentDeleteView, ArticleLikeCreate,
    ArticleLikeDelete)
...
urlpatterns = [
    ...
    path('article/<int:pk>/like/', ArticleLikeCreate.as_view(), name="article_like"),
    path('article/<int:pk>/unlike/', ArticleLikeDelete.as_view(), name="article_unlike"),
